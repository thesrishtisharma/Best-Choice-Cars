...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 19, 2021 at 08:47 PM
...
(8, 3, 'Maruti Suzuki', 'Ertiga', 2018, 10000, 550000, 'Petrol'),
...
--
ALTER TABLE `cars`
  ADD CONSTRAINT `cars_ibfk_1` FOREIGN KEY (`b_id`) REFERENCES `cars` (`id`);
COMMIT;
